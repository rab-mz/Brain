...
const en: Record<string, string> = {
  ...
  'insert.code': 'Code',
  'insert.table': 'Table',
  'table.rowAbove': 'Row above',
  'table.rowBelow': 'Row below',
  'table.delRow': 'Delete row',
  'table.colBefore': 'Column before',
  'table.colAfter': 'Column after',
  'table.delCol': 'Delete column',
  'table.alignLeft': 'Align left',
  'table.alignCenter': 'Align center',
  'table.alignRight': 'Align right',
  'table.tidy': 'Tidy columns',
  'table.delete': 'Delete table',
  'table.convert': 'Turn into a table',
  'fmt.bold': 'Bold',
  'fmt.italic': 'Italic',
  ...
  'folder.empty': 'empty',
  'folder.rootRename':
    'The connected folder itself cannot be renamed from the browser (the app only holds a handle to it, not to its parent). Rename it in Finder, then reconnect it once.',
  'folder.subfolders': 'Folders in notes/',
  'folder.renameTip': 'Rename folder',
  'folder.noSubfolders': 'No subfolders yet — create one from the sidebar.',
  'folder.exists': 'A folder with that name already exists',
  'folder.colorCustom': 'Custom…',
  'folder.colorAuto': 'Automatic',
  'toast.renamed': 'Folder renamed',
  'bar.scrollTop': 'Back to top',
  ...
  'bar.width.normal': 'Note width: normal — click to widen',
  'bar.width.wide': 'Note width: wide — click to go full width',
  'bar.width.full': 'Note width: full — click for the normal one',
  ...
  'toast.fileCopyDrag': 'The browser cannot copy this file type — drag the card where you need it',
...
const it: Record<string, string> = {
  ...
  'insert.todo': 'Todo',
  'insert.code': 'Codice',
  'insert.table': 'Tabella',
  'table.rowAbove': 'Riga sopra',
  'table.rowBelow': 'Riga sotto',
  'table.delRow': 'Elimina riga',
  'table.colBefore': 'Colonna prima',
  'table.colAfter': 'Colonna dopo',
  'table.delCol': 'Elimina colonna',
  'table.alignLeft': 'Allinea a sinistra',
  'table.alignCenter': 'Allinea al centro',
  'table.alignRight': 'Allinea a destra',
  'table.tidy': 'Riallinea colonne',
  'table.delete': 'Elimina tabella',
  'table.convert': 'Converti in tabella',
  'fmt.bold': 'Grassetto',
  'fmt.italic': 'Corsivo',
  'fmt.code': 'Codice inline',
  'fmt.strike': 'Barrato',
  ...
  'folder.empty': 'vuota',
  'folder.rootRename':
    "La cartella collegata non si può rinominare dal browser (l'app ha accesso solo a lei, non alla cartella che la contiene). Rinominala dal Finder e poi ricollegala con un clic.",
  'folder.subfolders': 'Cartelle in notes/',
  'folder.renameTip': 'Rinomina cartella',
  'folder.noSubfolders': 'Nessuna sottocartella — creane una dalla barra laterale.',
  'folder.exists': 'Esiste già una cartella con quel nome',
  'folder.colorCustom': 'Personalizzato…',
  'folder.colorAuto': 'Automatico',
  'toast.renamed': 'Cartella rinominata',
  'bar.scrollTop': 'Torna in cima',
  ...
  'bar.width.normal': 'Larghezza nota: normale — clicca per allargare',
  'bar.width.wide': 'Larghezza nota: larga — clicca per tutta la pagina',
  'bar.width.full': 'Larghezza nota: tutta la pagina — clicca per tornare normale',
  ...
  'toast.fileCopyDrag': 'Il browser non può copiare questo tipo di file: trascina la card dove ti serve',
